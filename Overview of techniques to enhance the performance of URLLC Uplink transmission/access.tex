...
If GC PI is used, one GC PI and $N$ rescheduling UL grants are needed in the process. The aggregation level (AL) of GC PI achieve URLLC reliability requirement is: $R_{1}$. Rescheduling UL grant with eMBB reliability requirement is configured with a lower AL: $R_{2}$. The total ALs in the process are: $R_{1} + R_{2}\times N$.
